...
def fleet_menu(db_vehicle):
    while True:
        try:
            ...
            if option == 1:
                db_vehicle = register_car(db_vehicle)
            elif option == 2:
                request_vehicle_search_plate(db_vehicle)
            elif option == 3:
                request_vehicle_search_availability(db_vehicle)
            elif option == 4:
                return db_vehicle
            else:
